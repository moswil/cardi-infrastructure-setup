...
SECRET_KEY=51ac60a4dc60f6449673dca3969399d0bef7b04f47f24f2b1f580e516944212e89df73b67e2e154373e6780f28774986859f869a44a39a27d08b345f88dbc932
...
EOF
echo "\nDJANGO_ALLOWED_HOSTS=localhost ${IP_ADDRESS} 127.0.0.1 [::1]" >> env/app/prod.env
